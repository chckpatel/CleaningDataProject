...
#add two more for  activity and subject
...
#3 Label Activities
#Activity data is numeric. Change numeric value to associated meaning from activities data
